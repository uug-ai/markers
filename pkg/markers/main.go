...
func (m *Marker) Create(ctxTracer context.Context, tracer *opentelemetry.Tracer, client *mongo.Client, marker models.Marker, mediaId string) (models.Marker, error) {
	...
	insertedMarker, err := AddMarkerToMongodb(ctxTracer, tracer, client, marker, mediaId)
	if err != nil {
